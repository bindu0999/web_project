...
<li><a href="../logout.php">Logout</a></li>
  ...
  <tr>
    ...
    <td rowspan="2">&nbsp;</td>
       ...
       ?>
  <tr>
      <td colspan="2" ><input type="submit" style="width: 10em;  height: 2em; font-size: 15px;" name="chk" value="Check For Request" /> <br/><br/>  </td>
    </tr>
       </table>
       </div>
           <br/>
